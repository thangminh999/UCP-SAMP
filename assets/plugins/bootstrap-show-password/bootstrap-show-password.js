...
!function ($) {
    ...
    Password.prototype.init = function() {
        ...
        this.$icon = $([
            ...
            '<i class="fa-eye' + (this.options.white ? ' icon-white' : '') +
    ...
    Password.prototype.show = function(_relatedTarget) {
        ...
        this.$text.show();
        this.$icon.find('i')
            .removeClass('fa-eye ' + this.options.eyeOpenClass)
            .addClass('fa-eye-slash ' + this.options.eyeCloseClass);
    ...
    Password.prototype.hide = function(_relatedTarget) {
        ...
        this.$text.hide();
        this.$icon.find('i')
            .removeClass('fa-eye-slash ' + this.options.eyeCloseClass)
            .addClass('fa-eye ' + this.options.eyeOpenClass);
