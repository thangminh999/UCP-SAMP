...
echo  "\n" . '<!-- begin profile -->'.
           ...
           "\n" . ' <div class="profile-content card height-full">'.
			...
			"\n" . '<ul class="nav nav-tabs nav-justified">'.
                ...
                "\n" . '<li class="nav-item"><a href="#"  class="nav-link active">Đổi Mật Khẩu</a></li>'.
            ...
            echo '<div class="note note-lime note-lime m-b-15">'.
								...
								"\n" . '<strong>Mật khẩu mới dùng để đăng nhập: Game, UCP</strong>'.
								"\n" . '</p>'.
							 	"\n" . '</div>';
            	echo "\n" . '<form class="form-horizontal form-bordered" id="form-changename">'.
								"\n" . '<div class="form-group row">'.
									"\n" . '<label class="col-md-2 col-form-label text-center">Mật khẩu cũ</label>'.
									"\n" . '<div class="col-md-4">'.
									    "\n" . '<input data-toggle="password" data-placement="after" class="form-control" type="password" id="passwordold" placeholder="Mật khẩu cũ" />'.
									"\n" . '</div>'.
								"\n" . '</div>'.
								"\n" . '<div class="form-group row">'.
									"\n" . '<label class="col-md-2 col-form-label text-center">Mật khẩu mới</label>'.
									"\n" . '<div class="col-md-4">'.
									    "\n" . '<input data-toggle="password" data-placement="after" class="form-control" id="passwordnews" type="password" placeholder="Mật khẩu mới" />'.
									"\n" . '</div>'.
								"\n" . '</div>'.
								"\n" . '<div class="form-group row">'.
									"\n" . '<label class="col-md-2 col-form-label text-center">Xác nhận mật khẩu mới</label>'.
									"\n" . '<div class="col-md-4">'.
									    "\n" . '<input data-toggle="password" data-placement="after" class="form-control" id="repasswordnews" type="password" placeholder="Xác nhận mật khẩu mới" />'.
									"\n" . '</div>'.
								"\n" . '</div>'.
								  "\n" . '<div class="row">'.
								  "\n" . '<div class="col-md-2">'.
                    ...
                    "\n" . '<div class="col-md-6" id="button_chagename">'.
                     "\n" . ' <button class="btn btn-primary" type="button" onclick="changepassword()"><i class="fal fa-check-circle fa-1x"></i> Xác Nhận</button>'.
                    "\n" . '</div>'.
                 "\n" . ' </div>'.
							"\n" . '</form>'.
            "\n" . ' </div>'.
			...
			<script type="text/javascript">
				 ...
				 function changepassword(){
				 	var passwordold = $("#passwordold").val();
           			var passwordnews= $("#passwordnews").val();
           			var repasswordnews= $("#repasswordnews").val();
           			if (!passwordold || !passwordnews || !repasswordnews) {
          	 		...
          	 		$.ajax({
               			...
               			data    : {
                   			...
                   			passwordnews : passwordnews,
                   			repasswordnews :repasswordnews
               			},
                	success: (data) => {
                    	if (data.error) {
                    		setTimeout(function(){
                    		$("#button_chagename").html('<button class="btn btn-danger" type="button" onclick="changepassword()"><i class="fal fa-times-circle"></i> Làm lại</button>');
