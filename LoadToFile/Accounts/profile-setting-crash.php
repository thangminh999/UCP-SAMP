...
echo  "\n" . '<!-- begin profile -->'.
           ...
           "\n" . ' <div class="profile-content card height-full">'.
			...
			"\n" . '<ul class="nav nav-tabs nav-justified">'.
				...
				"\n" . '<li class="nav-item"><a href="#"  class="nav-link active">Fix Kẹt</a></li>';
            ...
            echo '<div class="note note-lime note-lime m-b-15">'.
								...
								"\n" . '<strong>Fix Kẹt là dùng để fix crash trong game</strong>'.
								"\n" . '</p>'.
							 	"\n" . '</div>';
            	echo "\n" . '<form class="form-horizontal form-bordered" id="form-active-forum">'.
                    ...
                    "\n" . '<div class="col-md-6" id="button_chagename">'.
                     "\n" . ' <button class="btn btn-primary" type="button" onclick="fixcrash()"><i class="fal fa-check-circle fa-1x"></i> Xác Nhận</button>'.
                    "\n" . '</div>'.
                 "\n" . ' </div>'.
							"\n" . '</form>'.
            "\n" . ' </div>'.
