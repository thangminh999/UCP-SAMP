...
echo  "\n" . '<!-- begin profile -->'.
           ...
           "\n" . ' <div class="profile-content card height-full">'.
			...
			"\n" . '<ul class="nav nav-tabs nav-justified">'.
                ...
                "\n" . '<li class="nav-item"><a href="#" class="nav-link active">Đổi Mã Pin</a></li>'.
            ...
            echo '<div class="note note-lime note-lime m-b-15">'.
								...
								"\n" . '<strong>Mã pin mới dùng để xác nhận tài khoản: Game, UCP</strong>'.
								"\n" . '</p>'.
							 	"\n" . '</div>';
            	echo "\n" . '<form class="form-horizontal form-bordered" id="form-changename">'.
								"\n" . '<div class="form-group row">'.
									"\n" . '<label class="col-md-2 col-form-label text-center">Mã pin cũ</label>'.
									"\n" . '<div class="col-md-4">'.
									    "\n" . '<input data-toggle="password" data-placement="after" class="form-control" type="password" id="pinold" placeholder="Mã pin cũ" />'.
									"\n" . '</div>'.
								"\n" . '</div>'.
								"\n" . '<div class="form-group row">'.
									"\n" . '<label class="col-md-2 col-form-label text-center">Mã pin mới</label>'.
									"\n" . '<div class="col-md-4">'.
									    "\n" . '<input data-toggle="password" data-placement="after" class="form-control" id="pinnews" type="password" placeholder="Mã pin mới" />'.
									"\n" . '</div>'.
								"\n" . '</div>'.
								"\n" . '<div class="form-group row">'.
									"\n" . '<label class="col-md-2 col-form-label text-center">Xác nhận mã pin mới</label>'.
									"\n" . '<div class="col-md-4">'.
									    "\n" . '<input data-toggle="password" data-placement="after" class="form-control" id="reppinnews" type="password" placeholder="Xác nhận mã pin mới" />'.
									"\n" . '</div>'.
								"\n" . '</div>'.
								  "\n" . '<div class="row">'.
								  "\n" . '<div class="col-md-2">'.
                    ...
                    "\n" . '<div class="col-md-6" id="button_chagename">'.
                     "\n" . ' <button class="btn btn-primary" type="button" onclick="changepincode()"><i class="fal fa-check-circle fa-1x"></i> Xác Nhận</button>'.
                    "\n" . '</div>'.
                 "\n" . ' </div>'.
							"\n" . '</form>'.
            "\n" . ' </div>'.
			...
			<script type="text/javascript">
				 ...
				 function changepincode(){
				 	var pinold = $("#pinold").val();
           			var pinnews= $("#pinnews").val();
           			var reppinnews= $("#reppinnews").val();
           			if (!pinold || !pinnews || !reppinnews) {
