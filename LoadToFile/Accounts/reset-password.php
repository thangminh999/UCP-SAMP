        ...
        "\n" . '<div class="login bg-white-transparent-1 animated fadeInDown">'.
            ...
            "\n" . '<div class="login-header">'.
                "\n" . '<div class="brand">'.
                 ...
                 "\n" . '<small>Khôi phục mật khẩu</small>'.       
                "\n" . '</div>'.
                "\n" . '<div class="icon">'.
            ...
            "\n" . '<div class="login-content">';
             if (isset($_POST['submit'])) {
                ...
                if (empty($error)) {
                   if (THCMS_Controller_Function::KiemTraEmail($email)) {
                    ...
                    $error['check_db'][]  = '<div class="alert alert-danger fade show">Email không tồn tại trên hệ thống</div>';
                        ...
                        $getmail = THCMS_Controller_Function::GetMailler(2);
                        $tieude = $getmail['tieude'];
                        $title = $getmail['title'];
                        $noidung = $getmail['noidung'];
                        $array = array('[ACCOUNT]', '[TOKEN]','[URL]','[RSPW]','[LOGO_TEXT]','[COPYRIGHT]');
                        $array_replace = array($get_accounts['Username'], $randtoken, $system['url'], 'Auth/Mailer/ResetPassword', $system['logo_text'],$system['copyright']);
                        $doilenh = str_replace($array, $array_replace, $noidung);
                        $to = $email;
                        $name = $get_accounts['Username'];
                         if(THCMS_Controller_Function::SaveTokenResetPassword($randtoken,$get_accounts['id'])){
                ...
                echo "\n" . '<form action="" method="post" class="margin-bottom-0  m-t-20">'.
                (isset($error['check_db']) ? '' . implode('', $error['check_db']) . '' : '') .
                    ...
                    "\n" . '</div>'.
                     ...
                     "\n" . '<div class="col-sm-4">'.
                       ...
                       "\n" . '</div>'.     
                        "\n" . '<div class="col-sm-4">'.
                        "\n" . '<div class="text-center"><a href="#" class="btn btn-lime m-r-5 m-b-5">Quên Mật Khẩu</a></div>'.
                       "\n" . '</div>'. 
                        "\n" . '<div class="col-sm-4">'.
