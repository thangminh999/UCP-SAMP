...
if($user_id){
	if($user != $datauser['Username'] || $datauser['Active_Forum'] >= 1){
...
echo  "\n" . '<!-- begin profile -->'.
           ...
           "\n" . ' <div class="profile-content card height-full">'.
            ...
            echo '<div class="note note-lime note-lime m-b-15">'.
								"\n" . '<h4><b>Lưu Ý:</b></h4>'.
								"\n" . '<p>'.
								"\n" . 'Số Lần: <b>1 Lần/Accounts</b><br>'.
								"\n" . '<strong>Sao khi kích hoạt. Bạn cũng có thể đăng nhập vào hệ thống diễn đàn tại: '.$system['url_forum'].'</strong>'.
								"\n" . '</p>'.
							 	"\n" . '</div>';
            	echo "\n" . '<form class="form-horizontal form-bordered" id="form-active-forum">'.
								"\n" . '<div class="form-group row">'.
									"\n" . '<label class="col-md-2 col-form-label text-center">Tên tài khoản:</label>'.
									"\n" . '<div class="col-md-4">'.
								...
								"\n" . '<div class="form-group row">'.
									...
									"\n" . '<div class="col-md-4">'.
									   "\n" . '<div class="input-group">'.
										"\n" . '<div class="input-group-prepend"><span class="input-group-text"><i class="fal fa-at"></i></span></div>'.
								...
								"\n" . '<div class="form-group row">'.
									...
									"\n" . '<div class="col-md-4">'.
									    "\n" . '<input data-toggle="password" data-placement="after" class="form-control" type="password" id="password" placeholder="Mật khẩu" />'.
									"\n" . '</div>'.
								"\n" . '</div>'.
								  "\n" . '<div class="row">'.
								  "\n" . '<div class="col-md-2">'.
                    ...
                    "\n" . '<div class="col-md-6" id="button_chagename">'.
                     "\n" . ' <button class="btn btn-primary" type="button" onclick="activeforum()"><i class="fal fa-check-circle fa-1x"></i> Xác Nhận</button>'.
                    "\n" . '</div>'.
                 "\n" . ' </div>'.
							"\n" . '</form>'.
            "\n" . ' </div>'.
           ...
           ?>
			<script type="text/javascript">
				 ...
				 function activeforum(){
                	...
                	success: (data) => {
                    	if (data.error) {
                    		setTimeout(function(){
                    		$("#button_chagename").html('<button class="btn btn-danger" type="button" onclick="activeforum()"><i class="fal fa-times-circle"></i> Làm lại</button>');
            ...
            if (text === null || text === '') { text = 'Không có nội dung để hiển thị'; }
