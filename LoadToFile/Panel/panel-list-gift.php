...
$textl = 'Panel: Danh sách Nạp Tiền MoMo';
			...
			"\n" . '<div class="panel panel-inverse">'.
				...
				"\n" . '<div class="panel-heading">'.
					"\n" . '<div class="panel-heading-btn">'.
							...
							"\n" . '</div>'.
					"\n" . '<h4 class="panel-title">Tổng Danh Sách Chuyển Tiền MoMo</h4>'.
				"\n" . '</div>'.
				"\n" . '<!-- end panel-heading -->'.
				"\n" . '<!-- begin panel-body -->'.
             ...
             "\n" . ' <table id="panel_list_nap_momo" class="table table-bordered" style="width:100%">'.
				"\n" . '</table>'.
			...
			"\n" . '<div class="panel panel-inverse">'.
				...
				"\n" . '<div class="panel-heading">'.
					"\n" . '<div class="panel-heading-btn">'.
								...
								"\n" . '<a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-warning" data-click="panel-collapse"><i class="fa fa-minus"></i></a>'.
							"\n" . '</div>'.
					"\n" . '<h4 class="panel-title">Danh Sách Chuyển Tiền MoMo Có Tên Tài Khoản</h4>'.
				"\n" . '</div>'.
				"\n" . '<!-- end panel-heading -->'.
				"\n" . '<!-- begin panel-body -->'.
				"\n" . '<div class="panel-body">'.
				"\n" . '<button type="button" class="btn btn-primary waves-effect" style="display: none;" data-toggle="modal" data-target="#edit-toys" id="btn-edit">Chỉnh Sửa</button>'.
					"\n" . ' <div class="table-responsive">'.
             "\n" . ' <table id="panel_list_nap_momo_2" class="table table-bordered" style="width:100%">'.
				"\n" . '</table>'.
			...
			"\n" . '<div class="panel panel-inverse">'.
				...
				"\n" . '<div class="panel-heading">'.
					"\n" . '<div class="panel-heading-btn">'.
								...
								"\n" . '<a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-warning" data-click="panel-collapse"><i class="fa fa-minus"></i></a>'.
							"\n" . '</div>'.
					"\n" . '<h4 class="panel-title">Danh Sách Chuyển Tiền Lỗi Tài Khoản Chờ Xử Lý</h4>'.
				"\n" . '</div>'.
				"\n" . '<!-- end panel-heading -->'.
				"\n" . '<!-- begin panel-body -->'.
				"\n" . '<div class="panel-body">'.
				"\n" . '<button type="button" class="btn btn-primary waves-effect" style="display: none;" data-toggle="modal" data-target="#edit-toys" id="btn-edit">Chỉnh Sửa</button>'.
					"\n" . ' <div class="table-responsive">'.
             "\n" . ' <table id="panel_list_nap_momo_3" class="table table-bordered" style="width:100%">'.
				"\n" . '</table>'.
