			...
			"\n" . '<div class="panel panel-inverse">'.
				...
				"\n" . '<div class="panel-heading">'.
					"\n" . '<div class="panel-heading-btn">'.
							...
							"\n" . '</div>'.
					"\n" . '<h4 class="panel-title">Danh Sách Member Nạp Thẻ</h4>'.
				"\n" . '</div>'.
				"\n" . '<!-- end panel-heading -->'.
				"\n" . '<!-- begin panel-body -->'.
				"\n" . '<div class="panel-body">'.
					"\n" . ' <div class="table-responsive">'.
             "\n" . ' <table id="panel_list_reload" class="table table-bordered">'.
				"\n" . '</table>'.
			...
			"\n" . '<div class="panel panel-inverse">'.
				...
				"\n" . '<div class="panel-heading">'.
					"\n" . '<div class="panel-heading-btn">'.
								...
								"\n" . '<a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-warning" data-click="panel-collapse"><i class="fa fa-minus"></i></a>'.
							"\n" . '</div>'.
					"\n" . '<h4 class="panel-title">Danh Sách Member Nạp Thẻ MoMo</h4>'.
				"\n" . '</div>'.
				"\n" . '<!-- end panel-heading -->'.
				"\n" . '<!-- begin panel-body -->'.
				"\n" . '<div class="panel-body">'.
					"\n" . ' <div class="table-responsive">'.
             "\n" . ' <table id="panel_list_reload_momo" class="table table-bordered">'.
				"\n" . '</table>'.
