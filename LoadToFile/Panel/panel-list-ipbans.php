...
$headmod = 'panel-list-ipbans';
$textl = 'Panel: Danh sách IP Banned';
			...
			"\n" . '<div class="panel panel-inverse">'.
				...
				"\n" . '<div class="panel-heading">'.
					"\n" . '<div class="panel-heading-btn">'.
							...
							"\n" . '</div>'.
					"\n" . '<h4 class="panel-title">Danh Sách IP Banned</h4>'.
				"\n" . '</div>'.
				"\n" . '<!-- end panel-heading -->'.
				"\n" . '<!-- begin panel-body -->'.
				"\n" . '<div class="panel-body">'.
					"\n" . ' <div class="table-responsive">'.
             "\n" . ' <table id="panel_list_ipbans" class="table table-bordered">'.
				"\n" . '</table>'.
